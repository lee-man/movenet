cd src
python main.py single_pose --exp_id coco_movenet --dataset active --arch movenet --batch_size 24 --master_batch 4 --lr 2.5e-4 --gpus 0,1,2,3 --num_epochs 150 --lr_step 120 --num_workers 16 --resume #--load_model ../models/ctdet_movenet.pth
